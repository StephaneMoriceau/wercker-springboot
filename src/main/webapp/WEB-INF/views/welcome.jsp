...
<body>
    ...
    <div class="container">
      ...
      <div class="blueBannerHeading">
        <h1 class="blueBannerTitleWithSubtitle">
          <a style="color: #ff5733">Oracle Container Cloud Service + Wercker (STEP 3 - adding deployment to ACCS)</a>
        </h1>
      </div>
  ...
  <div class="container serviceContainer" style="margin-top: 150px;">
    <div class="overviewLayout">
      <div>
              <br>SpringBoot application demo by STEPHANE MORICEAU. Current server time: <%= new java.util.Date() %> <br>
              <br>
              <p>
